...
namespace Config {
    ...
    constexpr u8 getResourceBaseValue(ResourceType type) {
        switch (type) {
            case ResourceType::IRON: return IRON_BASE_VALUE;
            case ResourceType::GOLD: return GOLD_BASE_VALUE;
            case ResourceType::GEMS: return GEMS_BASE_VALUE;
            case ResourceType::EXP:  return EXP_BASE_VALUE;
            default: return 0;
        }
    }
